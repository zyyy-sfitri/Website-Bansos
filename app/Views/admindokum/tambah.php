...
<a href="<?= base_url('admin/notifikasi') ?>" class="btn btn-light rounded-pill fw-bold px-3 py-1">
  ...
  <div class="sidebar" id="sidebar">
   ...
   <!-- Main -->
  <main class="container" style="margin-left: 2px; margin-top: 100px; margin-bottom: 100px; max-width: 1200px;">
    <div class="card shadow-sm" style="border-radius: 20px;">
      <div class="card-body p-5">
        <h2 class="text-center fw-bold mb-5" style="font-size: 2rem;">Data Berita</h2>
