...
<a href="<?= base_url('admin/notifikasi') ?>" class="btn btn-light rounded-pill fw-bold px-3 py-1">
  ...
  <div class="main">
    ...
    <div class="switch-container mb-4">
      <a href ="<?= base_url('/admindokum/berita') ?>" class="switch-btn" style="border-radius:0 25px 25px 0;">Berita</a>
      <a href ="<?= base_url('/dokumc') ?>" class="switch-btn active" style="border-radius:25px 0 0 25px; backround-color:#1B673B;color:white;">Dokumentasi</a>
    </div>
    ...
    <div class="table-responsive">
          ...
          ?>
            <tr> 
              <th scope="row"><?= $i++ ?></th>
                  ...
                  <td><?= $b['deskripsi'] ?? '-' ?></td>
                  <td>
                    <a href="<?= base_url('/dokumc/hapus/'.$b['id_dokumentasi']) ?>" 
      ...
      <a href="<?= base_url('/dokumc/tambah') ?>" class="btn btn-primary" style="background-color: #1B673B;" >Tambah Data Dokumentasi</a>
    </div>
  </div>
