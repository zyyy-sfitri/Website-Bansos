  ...
  <div class="main">
    ...
    <div class="table-responsive" style="margin: 0 px; box-shadow: 0 4px 12px rgba(147,146,146,0.15); border-radius: 10px;">
        ...
        <div class="d-flex justify-content-between align-items-center" style="margin: 0 20px;">
            <div>
                <h4><b>Data Penerima Bantuan Sosial</b></h4>
                <h7>Kelola data penerima bantuan.</h7>
            </div>

    <form action="/adminuser/penerima" method="post" class="d-flex">
        <input type="text" name="cari" class="form-control me-2" placeholder="Cari data..." style="width: 180px;">
        <button class="btn btn-outline-secondary" type="submit">Cari</button>

        <?php if (!empty($cari)): ?>
        <a href="/adminuser/penerima" class="btn btn-outline-secondary"
           style="padding: 6px; background:#ccc; text-decoration:none; margin-left:5px;">
            Reset
        </a>
    <?php endif; ?>
    </form>
    </div><br>
      <table class="table align-middle" style="margin: 0 20px">
        <thead>
          <tr>
            <th>ID</th>
